...
Install `nightly-2025-08-10` on which rapx is compiled with. This just needs to do once on your machine. If the toolchain exists,
...
```shell
cargo +nightly-2025-08-10 rapx [rapx options] -- [cargo check options]
```
