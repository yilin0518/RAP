...
Install `nightly-2025-08-22` on which rapx is compiled with. This just needs to do once on your machine. If the toolchain exists,
this will do nothing.

```shell
rustup toolchain install nightly-2025-08-22 --profile minimal --component rustc-dev,rust-src,llvm-tools-preview
cargo +nightly-2025-08-22 install rapx --git https://github.com/Artisan-Lab/RAPx.git
```
...
```shell
cargo +nightly-2025-08-22 rapx [rapx options] -- [cargo check options]
```

or by setting up default toolchain to the required version.
```shell
rustup default nightly-2025-08-22
```
